gwglmnet.fit.nenparallel = function(x, y, family, coords, indx, fit.loc, D, s, mode.select, verbose, prior.weights, gweight, target, beta1, beta2, tol=1e-25, longlat=FALSE, adapt, precondition=FALSE, tuning, simulation, predict, N, oracle, interact, alpha, shrunk.fit, AICc) {
