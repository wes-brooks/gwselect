gwglmnet.cv.f = function(formula, data, weights, family, bw, coords, gweight, env, oracle, mode.select, verbose, longlat, tol.loc, bw.method, N, parallel, interact, shrunk.fit, bw.select, resid.type) {    
    ...
    gwglmnet.model = gwglmnet(formula=formula, data=data, family=family,
        ...
        interact=interact, tol.loc=tol.loc,
